...
export function ComingSoonPage({
  ...
  return (
    <main
      ...
      className="relative mx-auto flex w-full max-w-screen-2xl flex-col gap-8 overflow-hidden px-4 py-16 sm:px-6 sm:py-24"
    >
      {/*
        The celestial engraving is on-metaphor for the routes that use
        this shell — `/graph` is literally a constellation map, and the
        bare "coming soon" surface benefits from the same orientation
        and warmth the login card gets. Mounted full-bleed behind the
        content; the wrapper below lifts the copy above it.
      */}
      <CelestialBackdrop />
